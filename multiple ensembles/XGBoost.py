...
class xgbRegression(Tree):
    ...
    def fit(self, X, y, exp, internal_rate, lap1_rate):
        ...
        y_and_pre = None
        n_ensemble = int(self._n_estimator / self._trees_in_ensemble)
        exp_ensemble = exp / n_ensemble
        ...
        for i in range(self._n_estimator):
            ...
            randomly_pick = int(n_samples * shrinkage * np.power(1 - shrinkage, te - 1) / (1 - np.power(1 - shrinkage, self._trees_in_ensemble)))
